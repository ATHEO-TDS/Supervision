...
#
# DESCRIPTION:
# This PowerShell script is designed to monitor Veeam Backup & Replication (VBR) backup copy job sessions.
...
try {
    ...
    $sessListBc = GetVBRBackupCopySession | Where-Object { -not ($_.JobName -in $ExcludedJobsArray) } | Group-Object JobName | ForEach-Object { $_.Group | Sort-Object SessionEndTime -Descending | Select-Object -First 1 }
