...
try {
    ...
    $sessListRp = GetVBRBackupSession |  Where-Object { -not ($_.JobName -in $excludedJobArray) } | Group-Object JobName | ForEach-Object { $_.Group | Sort-Object SessionEndTime -Descending | Select-Object -First 1}
